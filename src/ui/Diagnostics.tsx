...
export function Diagnostics() {
  ...
  return (
    <div className="diag" aria-live="polite">
      ...
      <div className="diag-sec">SYSTEM CAPABILITIES</div>
      <Row k="screen capture" v="Web getDisplayMedia (READY)" />
      <Row k="whatsapp" v="Meta API (Configurable in .env)" />
      <Row k="email" v="SMTP (Configurable in .env)" />
      <Row k="hud text input" v="ACTIVE (Press / or use bar)" />
      ...
      <div style={{ marginTop: '12px', display: 'flex', gap: '8px' }}>
        <button
          ...
          onClick={() => {
            useStore.getState().submitQuery('Perform a full system diagnostic self-test.')
            setOpen(false)
          }}
        >
